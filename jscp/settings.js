...
let settings = {
    ...
    sequence: 'Happy|Birthday|to|my|most|cherished|family|Serina!|❤️',
    ...
    pages: [
        ...
        { 
            ...
            content: 'From partners to the best family, thank you for staying by my side. ❤️' 
        },
        ...
        { 
            ...
            content: 'Your happiness means everything to me. I’ll always be here to support you. 🌟' 
        },
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        matrixColor1: '#ff69b4', // Màu pink mẫu
        matrixColor2: '#ff1493', // Màu pink mẫu
        sequence: 'HAPPY|BIRTHDAY|TO|MY|MOST|CHEIRSHED|FAMILY|SERINA!|❤️',
        // sequence: 'HAPPY|BIRTHDAY|TO|ANITA|❤',
        sequenceColor: '#ff69b4', // Màu pink mẫu
        gift: './image/happy3.gif',
        enableBook: true,
